...
gulp.task("files", function () {
    gulp.src(dir.src + 'files/*.*')
        .pipe(gulp.dest(dir.dest + 'files/'))
});

gulp.task("compile", ["jade", "js", "less", "img", "files"]);

gulp.task("default", ["jade", "js", "less", "img", "files"], function() {
    ...
    gulp.watch(dir.src + "files/*.*", function() {
        gulp.run("files");
    });
});
